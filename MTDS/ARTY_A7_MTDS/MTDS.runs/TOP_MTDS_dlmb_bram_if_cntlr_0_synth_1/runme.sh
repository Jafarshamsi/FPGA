...
HD_PWD='E:/Projects/MTDS/MTDS.runs/TOP_MTDS_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_MTDS_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_MTDS_dlmb_bram_if_cntlr_0.tcl
