...
HD_PWD='E:/Projects/MTDS/MTDS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_MTDS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_MTDS_wrapper.tcl
