...
HD_PWD='D:/MYGITHUB/MYCODES/FPGA/IF_UART/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_UART_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_UART_wrapper.tcl -notrace
