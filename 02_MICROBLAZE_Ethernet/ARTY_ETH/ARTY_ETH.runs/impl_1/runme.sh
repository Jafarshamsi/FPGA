...
HD_PWD='E:/ARTY_projects/ARTY_ETH/ARTY_ETH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ARTY_ETH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_ARTY_ETH_wrapper.tcl -notrace
