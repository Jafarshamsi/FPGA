...
HD_PWD='D:/TEST/RTL_UART/RTL_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_UART_ECHO_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_UART_ECHO_TEST.tcl
