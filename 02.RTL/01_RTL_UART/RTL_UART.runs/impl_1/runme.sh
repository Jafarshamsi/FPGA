...
HD_PWD='D:/TEST/RTL_UART/RTL_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_UART_ECHO_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_UART_ECHO_TEST.tcl -notrace
