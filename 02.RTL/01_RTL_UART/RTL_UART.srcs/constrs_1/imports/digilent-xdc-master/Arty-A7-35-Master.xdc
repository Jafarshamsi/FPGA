...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports spi_ss_io]; #IO_0_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports spi_io0_io]; #IO_L4P_T0_15 Sch=ja[2] MOSI
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports spi_io1_io]; #IO_L4N_T0_15 Sch=ja[3] MISO
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports spi_sck_io]; #IO_L6P_T0_15 Sch=ja[4]
