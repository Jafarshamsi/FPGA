...
--Date        : Fri Apr 29 11:28:56 2022
--Host        : BlueRoseNew running 64-bit major release  (build 9200)
--Command     : generate_target TOP_ARTY_ETH_wrapper.bd
--Design      : TOP_ARTY_ETH_wrapper
...
entity TOP_ARTY_ETH_wrapper is
  port (
...
end TOP_ARTY_ETH_wrapper;

architecture STRUCTURE of TOP_ARTY_ETH_wrapper is
  component TOP_ARTY_ETH is
  port (
    sys_clock : in STD_LOGIC;
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
TOP_ARTY_ETH_i: component TOP_ARTY_ETH
     port map (
