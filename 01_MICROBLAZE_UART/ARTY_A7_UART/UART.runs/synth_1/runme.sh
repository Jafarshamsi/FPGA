...
HD_PWD='D:/MYGITHUB/MYCODES/FPGA/IF_UART/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_UART_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_UART_wrapper.tcl
