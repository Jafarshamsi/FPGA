...
HD_PWD='D:/MYGITHUB/MYCODES/FPGA/IF_UART/UART/UART.runs/TOP_UART_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_UART_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_UART_dlmb_v10_0.tcl
