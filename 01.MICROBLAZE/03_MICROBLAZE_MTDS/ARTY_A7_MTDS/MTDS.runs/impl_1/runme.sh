...
HD_PWD='E:/Projects/MTDS/MTDS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_MTDS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_MTDS_wrapper.tcl -notrace
